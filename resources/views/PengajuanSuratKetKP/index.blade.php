    ...
    <div class="col-sm-12 col-md-12">
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/guru">Pengajuan Surat Ket KP</a></li>
            </ol>
        </nav>
    </div>
</div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered" style="width:100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach ($pengajuansuratketkp as $index => $result)
                                    <tr>
                                        <td>{{$index + 1}}</td>
                                        ...
                                        <td>{{$result->pimpinan}}</td>
                                        <td>{{$result->noTelp}}</td>
                                        <td>{{$result->alamat}}</td>
                                        <td>{{$result->fax}}</td>
                                        <td>{{$result->dokumen}}</td>
                                        <td>{{$result->statusverifikasi}}</td>
                                     
                                        <td><a href="/mahasiswa/pengajuansuratketkp/vedit/{{ $result->id }}" class="btn btn-success text-light">Show/Edit </a>
                                        </td>
